...
import {
  PDPState as State,
  pdpInitialState as initialState,
  pdpStateSchema as schema,
  setPDP as setSlice,
} from '@store/project/system/pdp';

import { scale } from '@scripts/helpers';

const SHORT_NAME = 'PDP';
const FULL_NAME = 'PDP';
const SETTINGS_OF = 'PDP';

const useData = () => useSelector<RootState, State>(state => state.project.system.pdp);
