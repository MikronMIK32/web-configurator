...
const PccForm = ({ children }: { children: ReactNode }) => {
  ...
  const otp = useSelector<RootState, PccState>(state => state.project.system.pcc);
...
const PccInner = () => {
  ...
  const pcc = useSelector<RootState, PccState>(state => state.project.system.pcc);
