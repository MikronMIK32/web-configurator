...
import {
  GPIOState as State,
  gpioInitialState as initialState,
  gpioStateSchema as schema,
  setGPIO as setSlice,
} from '@store/project/system/gpio';

import { scale } from '@scripts/helpers';

const SHORT_NAME = 'GPIO';
const FULL_NAME = 'GPIO';
const SETTINGS_OF = 'GPIO';

const useData = () => useSelector<RootState, State>(state => state.project.system.gpio);
