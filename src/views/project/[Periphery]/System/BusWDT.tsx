...
import {
  BusWDTState as State,
  busWdtInitialState as initialState,
  busWdtStateSchema as schema,
  setBusWDT as setSlice,
} from '@store/project/system/bus-wdt';

import { scale } from '@scripts/helpers';

const SHORT_NAME = 'Bus WDT';
const FULL_NAME = 'Bus WDT';
const SETTINGS_OF = 'Bus WDT';

const useData = () => useSelector<RootState, State>(state => state.project.system.busWdt);
