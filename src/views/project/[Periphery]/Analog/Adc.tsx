...
import { AdcChannel, AdcState, VRef, adcInitialState, adcStateSchema, setAdc } from '@store/project/analog/adc';
...
const AdcForm = ({ children }: { children: ReactNode }) => {
  ...
  const adc = useSelector<RootState, AdcState>(state => state.project.analog.adc);
