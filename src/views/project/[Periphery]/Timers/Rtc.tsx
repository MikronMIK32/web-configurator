...
const RtcSettings = () => {
  ...
  // const rehydrated = useSelector<ProjectState, boolean>(
...
const RtcForm = ({ children }: { children: ReactNode }) => {
  ...
  const rtc = useSelector<RootState, RtcState>(state => state.project.timers.rtc);
    ...
    >
      <Form
        ...
        onSubmit={vals => {
          ...
          const newVals = store.getState().project.timers.rtc;
          form.reset(newVals);
        }}
        onReset={() => {
